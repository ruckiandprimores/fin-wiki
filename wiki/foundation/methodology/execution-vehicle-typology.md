...
This page is the durable reference the instrument dossiers and living cards classify against.
...
**Classification discipline:** every wrapper dossier tags its role (a / b / c) up front, then
...
- [[investment/tech-leaders-card|Tech Leaders + Key ETFs (living card)]] — the broad-ETF NVDA-concentration read in practice
- [[foundation/macro/btc-state-card|BTC State Card]] — the L1-HODL role-(b) wrappers in their live context
