...
| **Treasury-vehicle mode (dim. 8)** | **Core mode-shift STRUCTURAL as of 2026-07** — Strategy's largest-ever sale (3,588 BTC / ~$216M, Jun 29–Jul 5) + a formalized $1.25B BTC Monetization Program made sell-to-fund-dividends a standing mechanism at the #1 vehicle; periphery progressed from forced sales to complete exits (K Wave first full corporate liquidation ~Jul 2). Supply-shock trigger still NOT met (~1 of 3 top-10 vehicles in-mode). See [[foundation/macro/treasury-vehicle-cascade-watch#status-update|cascade-watch status update 2026-07-12]] |
...
**July-episode markers (appended 2026-07-12; contemporaneous trail continues):**

- **ETF-flow falsifier state (as of 2026-07-12):** a **second streak** ran Jun 18 → Jul 1 (**10 trading days, −$2.73B**; IBIT alone −$2.24B / ~36k BTC, its own streak ≥12 sessions — still −$40.4M on Jul 2 as the complex flipped). **June 2026 = worst monthly outflow on record (~$4.1–4.5B**, methodology-dependent). Streak broke Jul 2 (+$221.7M, largest daily inflow in ~2 months, FBTC-led) → ~+$509M over 3 inflow days → Jul 8/9 negative (−$84.9M/−$95.3M) → **Jul 10 positive again (+$90.4M)**. Post-break pattern: +4/−2 days, no streak >2 days either way, July MTD ~+$125M — **fragile/choppy stabilization, NOT a confirmed inflow regime**. Cumulative since May 7: −$8.95B over 34 negative days (5 positive); AUM ~$74–77B (IBIT $44.9B). **Falsifier arithmetic unchanged: 2026 max streak = 13 trading days (May 15 → Jun 3/4) vs the 90-day trigger — far from firing.** ([CoinDesk Jul 3](https://www.coindesk.com/markets/2026/07/03/finally-usd221-million-flow-into-bitcoin-etfs-ending-a-painful-10-day-outflow-streak) · [BeInCrypto/Glassnode](https://beincrypto.com/bitcoin-etfs-bleed-8-95-billion-in-two-months-and-the-selling-isnt-over/) · [CryptoBriefing Jul 10](https://cryptobriefing.com/bitcoin-ethereum-etf-inflows-july-10/))
- **Treasury-vehicle dimension turned STRUCTURAL:** Strategy's **largest-ever BTC sale** (3,588 BTC / ~$216M, Jun 29–Jul 5; 8-K Jul 6) + a formalized **$1.25B BTC Monetization Program** (unused as of Jul 5) — sell-to-fund-dividends is now a standing mechanism at the #1 vehicle, superseding the June "sale-then-rebuy" read; **K Wave Media became the first corporate holder to fully liquidate its BTC treasury** (~Jul 2). Full state: [[foundation/macro/treasury-vehicle-cascade-watch#status-update|cascade-watch §Status Update (2026-07-12)]].
...
- The **live BTC state card** — Regime 15's current objective state, updated each daily-review iteration — is maintained operationally, outside this knowledge base; this episode is being watched live there.
