...
- Status: capability now exists (live-demo fills); calibration unrun
...
The L1 HODL sleeve was activated as a paper opening tranche this cycle; the ETF-flow falsifier guards it. State as of 2026-06-12: record 13-trading-day outflow streak (~$4.33–4.4B) ended Jun 5 but did **NOT** flip to an inflow regime (Jun 8 BTC→ETH rotation; YTD spot-BTC-ETF flows negative first time since 2024 launch). **Falsifier arithmetic: max streak 13d vs the 90-day trigger — far from firing.** Watch: streak restarts.
...
Per [[../foundation/macro/treasury-vehicle-cascade-watch#status-update|cascade-watch (2026-06-12)]]: the forced-selling signature flickered live then partially reversed — **first confirmed forced-liquidation evidence appeared at the periphery** (weaker DATs), but the core reversed (Strategy dip-bought ~Jun 9, miners re-accumulating since Jun 5, Metaplanet floating buybacks not sales). **Open**: does periphery forced-selling propagate toward any top-10 vehicle? Supply-shock trigger NOT met; Q2 disclosure window (July–August) is the next refresh.

- Source: [[../foundation/macro/treasury-vehicle-cascade-watch]]
- Status: signature partially reversed; propagation watch hot
...
- Status: capability-not-yet-built; reframed as card-signal candidate
- Decides: Coinglass feed priority on the capability roadmap
...
- Status: substrate threshold crossed; deferred repeatedly
...
- Status: pending wiki-session prioritization
